/**
    ...
    @author Sang-sik Kim
*/
#ifndef __TFTP_CORE_H__
#define __TFTP_CORE_H__
...
/* Enabled here, unlike upstream. With it off the client ACKs every block and
 * throws the payload away, so a transfer reports success without the example
 * ever having seen the file. tftp_client.c implements save_data(). */
#define F_STORAGE
