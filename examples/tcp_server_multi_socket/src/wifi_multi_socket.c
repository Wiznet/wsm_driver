 ...
 *
 * Wi-Fi socket vtable for the backend-neutral server engine (multi_socket.c).
 * The Wi-Fi and Ethernet servers are started identically via
...
const multi_socket_ops_t wifi_multi_socket_ops = {
